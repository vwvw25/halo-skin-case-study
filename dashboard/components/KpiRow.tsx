...
export function KpiRow() {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:grid-cols-5">
      <Kpi label="Blended CAC" value={usd(h.blended_cac, 2)} note="cost per attributed new customer" />
      <Kpi
      ...
      />
      <Kpi label="Target-cohort share" value={pct(h.target_cohort_share)} note="of matured customers" />
      <Kpi label="Customers" value={count(h.customers_total)} note="attributed to Meta" />
    </div>
  );
}
